        ...
        <div class="form_01">
            ...
            <ul>
                <li>
                    ...
                    <input type="text" name="me_recv_mb_id" value="<?php echo $me_recv_mb_id ?>" id="me_recv_mb_id" required class="frm_input full_input required" size="47" placeholder="받는 회원아이디(닉네임이 아닌 회원아이디로 작성해야 합니다.)">
