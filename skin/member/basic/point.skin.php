...
<div id="point" class="new_win">
    ...
    <table>
        <thead>
            <tr>
                <th> 전체  </th> <th> 내용 </th> <th> 만료 </th> <th> 지급 </th> <th> 사용 </th>
            </tr>
        </thead>
        ...
        <tfoot>
            <tr> 
                <td> 보유포인트 <td>
                <td> <i class="fa fa-database" aria-hidden="true"></i> <?php echo number_format($member['mb_point']); ?> <td>
            </tr>
            <tr>
                <td> 소계 </td>
                <td> <?php echo $sum_point1; ?> <td>
                <td> <?php echo $sum_point2; ?></span></td>
            </tr>
        </tfoot>
    </table>
    <?php
